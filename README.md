...
- `magi:smoke:full`: 在 smoke check 后跑一轮真实 MAGI prompt，并断言 `mcp.call`、`council-tools`、`action-loop`、`synthesis-stream`、auditRef、无人格掉线、无 failed events 和最终回答里的 `MAGI_CAN_SEE_CODE_YES`。
